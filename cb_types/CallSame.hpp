...
/**
*
* @brief DataWrapper that executes callbacks when new data is the same as the current data.
*
...
class CallSame : public DataWrapper<T>
{
    ...
    * 
    * Overwrite current data with a new value. When this function is called, if the new data is the same as the current data all followers within this DataWrapper 
