...
class DataWrapper
{
    ...
    public:
         ...
         * @param execute_immediately if true the call-back is executed in the same thread in which set() was called, only recommended for short
         * call-back functions
    ...
    protected:
        ...
        std::vector<Follower>
                immediate_follower_list; ///<list of followers for which callbacks are executed immediately from the thread which set() was called
